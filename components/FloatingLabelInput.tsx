...
import { View, TextInput, Animated, Text, TextInputProps, StyleSheet } from 'react-native';
...
const FloatingLabelInput: React.FC<FloatingLabelInputProps> = ({
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View className={`bg-white rounded-lg border flex-row items-center ${borderColor}`}>
                {nameIcon && (
